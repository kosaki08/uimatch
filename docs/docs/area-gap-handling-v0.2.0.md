...
# 他の指標は全て OK でも...
npx @uimatch/cli compare figma=... story=... selector=...
...
npx @uimatch/cli compare ... profile=component/strict
# areaGapCritical: 15%
# → 15% 超えても、他が OK なら通過

# component/dev プロファイル
npx @uimatch/cli compare ... profile=component/dev
# areaGapCritical: 20%
# → 20% 超えても、他が OK なら通過

# lenient プロファイル
npx @uimatch/cli compare ... profile=lenient
# areaGapCritical: 30%
# → 30% 超えても、他が OK なら通過
```
